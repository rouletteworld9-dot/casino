...
const ResultDisplay = ({ className }) => {
  ...
  return (
    <div className="w-full sm:h-40 flex justify-center sm:justify-center pointer-events-none py-2">
      <div
        className={`flex sm:h-20 items-center relative text-xl font-bold ${className}`}
      >
        {/* Left neighbor */}
        <div
          style={{
