...
const Navbar = () => {
  ...
  return (
    <div className="bg-deepPurple backdrop-blur border-b border-slate-800 p-4 flex justify-between items-center sticky top-0 z-20">
      <h1 className="text-lg md:text-2xl font-bold bg-gradient-to-r from-purple-200 to-purple-400 bg-clip-text text-transparent">
        Casino Admin
      </h1>
